...
namespace Nexus.SPTMod {
	public class HideoutTargetController {
		...
		public Boolean IsInitialized {
			get { return this._firstTarget != null && this._secondTarget != null && this._thirdTarget != null; }
		}

		public Boolean IsUp(Int32 targetIndex) {
			switch (targetIndex) {
				case 0: {
					return this._firstTarget.transform.Find("metal_target_LOD0").position.y > -1f && this._firstTarget.transform.Find("metal_target_LOD1").position.y > -1f;
				}
				case 1: {
					return this._secondTarget.transform.Find("metal_target_LOD0").position.y > -1f && this._secondTarget.transform.Find("metal_target_LOD1").position.y > -1f;
				}
				case 2: {
					return this._thirdTarget.transform.Find("metal_target_LOD0").position.y > -1f && this._thirdTarget.transform.Find("metal_target_LOD1").position.y > -1f;
				}
		...
		public Transform[] GetTargetGameObjects(Int32 targetIndex) {
			switch (targetIndex) {
				case 0: {
					return new[] {this._firstTarget.Find("metal_target_LOD0"), this._firstTarget.Find("metal_target_LOD1")};
				}
				case 1: {
					return new[] {this._secondTarget.Find("metal_target_LOD0"), this._secondTarget.Find("metal_target_LOD1")};
				}
				case 2: {
					return new[] {this._thirdTarget.Find("metal_target_LOD0"), this._thirdTarget.Find("metal_target_LOD1")};
				}
				default: return null;
			}
		}
